    ...
    <header className="sticky top-0 z-50 border-b border-border/40 bg-background/80 backdrop-blur-xl">
      <div className="container mx-auto py-4">
        <div className="flex items-center justify-between">
          <button 
            className="flex items-center gap-3 cursor-pointer text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded-lg p-1 -m-1"
            onClick={() => navigate('/')}
            aria-label="ASPIRO AI - Go to home"
          >
            <div>
              <span className="text-xl font-bold tracking-tight block" aria-hidden="true">
                <span className="gradient-text">ASPIRO</span>
                <span className="text-foreground"> AI</span>
              </span>
              <span className="text-xs text-muted-foreground">Your AI Career Assistant</span>
            </div>
          </button>
